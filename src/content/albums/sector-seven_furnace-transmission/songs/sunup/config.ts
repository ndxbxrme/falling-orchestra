...
export const SONG3_CONFIG: SongConfig = {
  id: "song3",
  transport: {
    bpm: 120,
    beatsPerBar: 4,
  ...
  impactPalette: {
    voices: {
      ...
      bass: {
        ...
        tone: -0.46,
        pitchDrop: 0.0,
        routing: { dry: 0.9, drive: 0.4, delay: 0.04, reverb: 0.06, megaFx: 0.03 },
      },
      spark: {
        mode: "tick",
        gain: 0.46,
    ...
    buses: {
      dry: { gain: 0.72, tone: 0, drive: 0 },
      drive: { gain: 0.28, tone: 0.06, drive: 0.42 },
      delay: { gain: 0.0, tone: -0.2, drive: 0.18, delayTime: 0.24, feedback: 0.16 },
      reverb: { gain: 0.16, tone: -0.36, drive: 0.1 },
      megaFx: { gain: 0.01, tone: 0.14, drive: 0.42, delayTime: 1, feedback: 0.16 },
    },
    grooveFxProfile: {
      driveBoost: 0.2,
      delayBoost: 0.12,
      ...
      delayWobbleDepth: 0,
      filterResonance: 8.8,
      filterSweepDepth: 1750,
      filterLfoRateA: 0.039,
      filterLfoRateB: 0.012,
      filterLfoDepthA: 0.82,
      filterLfoDepthB: 0.58,
    },
    megaFxMacro: {
      duration: 1.25,
      decay: 1.9,
